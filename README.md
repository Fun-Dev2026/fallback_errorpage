...
- `index.html`: The primary standalone file containing all inline HTML, standard CSS keyframes, and inline SVGs to create the full presentation. Contains zero external dependencies. 

## Usage

Simply open `index.html` in any modern web browser to view the animation loop.

## License
Free to use and modify. Credit to WebComb is required.
